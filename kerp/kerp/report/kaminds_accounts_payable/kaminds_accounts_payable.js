...
frappe.query_reports["Kaminds Accounts Payable"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Kaminds Accounts Payable Summary"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Kaminds Accounts Payable Summary", { company: filters.company });
		});
...
erpnext.utils.add_dimensions("Kaminds Accounts Payable", 10);

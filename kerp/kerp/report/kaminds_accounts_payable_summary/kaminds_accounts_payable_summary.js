...
frappe.query_reports["Kaminds Accounts Payable Summary"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Kaminds Accounts Payable"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Kaminds Accounts Payable", { company: filters.company });
		});
...
erpnext.utils.add_dimensions("Kaminds Accounts Payable Summary", 9);
